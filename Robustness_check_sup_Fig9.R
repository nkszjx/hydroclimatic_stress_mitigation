...
# Robustness checks: Alternative clustering levels
...
model_urban <- felm(FVC ~ 1+WaterDeficit +
                      ...
                      ImperviousSurface + HumanSettlement + CityArea
                    | CityID  + year | 0 | CountryID, data = merged_dt_WaterDeficit)  
summary(model_urban)
...
model_urban <- felm(FVC ~ 1 + WaterDeficit +
                      ...
                      GDP_per_capita_PPP + HDI + Population +
                      ImperviousSurface + HumanSettlement + CityArea
                    | CityID  + year | 0 | CountryID, data = merged_dt_Seasonalityindex)  
summary(model_urban)
